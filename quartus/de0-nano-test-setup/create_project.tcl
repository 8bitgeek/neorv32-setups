...
if {$make_assignments} {
  ...
  set_global_assignment -name TOP_LEVEL_ENTITY neorv32_de0nano
  ...
  # local top entity (just a wrapper)
  set_global_assignment -name VHDL_FILE "neorv32_de0nano.vhd"
  ...
  set_location_assignment PIN_D12 -to uart0_rxd_i
  set_location_assignment PIN_A12 -to uart0_txd_o
