...
## Core: NEORV32
set fileset_neorv32 [glob ./../../neorv32/rtl/core/*.vhd]

## Design: processor top
set fileset_design neorv32_top_test.vhd

## Constraints
set fileset_constraints [glob ./*.xdc]

## Simulation-only sources
set fileset_sim [list ./../../neorv32/sim/neorv32_tb.simple.vhd ./../../neorv32/sim/uart_rx.simple.vhd]
